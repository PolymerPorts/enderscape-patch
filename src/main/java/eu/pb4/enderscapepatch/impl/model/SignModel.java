package eu.pb4.enderscapepatch.impl.model;
...
public class SignModel extends BlockModel {
    ...
    public SignModel(BlockState state) {
    ...
    public static void addBlock(String name, Block block) {
        EnderscapePolymerPatch.LATE_INIT.add(() -> MODEL_MAP.put(block, ItemDisplayElementUtil.getModel(EnderscapePolymerPatch.id("block/" + name))));
    }
}
