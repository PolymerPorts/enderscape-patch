...
public class BlockStateModelManager {
    ...
    public static final Map<Identifier, List<StateModelVariant>> UV_LOCKED_MODELS = new HashMap<>();
    ...
    public static void addBlock(Identifier identifier, Block block) {
        try {
            ...
            EnderscapePolymerPatch.LOGGER.warn("Failed to decode model for {}", identifier, e);
        }
    }
